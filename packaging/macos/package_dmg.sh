...
# Deploy the Qt Widgets runtime on the runner's local temporary disk.
...
# Rewrite the newly copied plug-ins' Qt framework references directly.
for relative_plugin in "${qt_runtime_plugins[@]}"; do
...
# --deep refreshes signatures after all native runtime edits above.
